...
After each move the game is checked automatically for a win or a draw. Players alternate turns, and the program allows replaying without restarting. test it!
